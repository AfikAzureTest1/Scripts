...
# Create variable for associating the NIC(s) of the VM(s) to a load balancer.
$backendPoolName = 'lb-be-pool'
$lbName = 'es-lb'
$esLbNatRuleNodeName = 'esnode-natrule'
$esLbNatRuleRestName = 'esrest-natrule'
...
# Create a virtual network, a subnet, and a public IP address.
